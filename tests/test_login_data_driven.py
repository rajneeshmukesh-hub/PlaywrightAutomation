...
csv_data=read_csv_data("opencartPlaywrightPythonFramework/testdata/logindata.csv")
json_data=read_json_data("opencartPlaywrightPythonFramework/testdata/logindata.json")
excel_data=read_excel_data("opencartPlaywrightPythonFramework/testdata/logindata.xlsx","Sheet1")
